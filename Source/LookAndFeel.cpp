...
LookAndFeel::LookAndFeel()
{
    ...
    juce::Typeface::Ptr typeface = juce::Typeface::createSystemTypefaceFor(BinaryData::EurostileBold_ttf, BinaryData::EurostileBold_ttfSize);
